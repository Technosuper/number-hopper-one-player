namespace SpriteKind {
    ...
    export const QuestionCoin = SpriteKind.create()
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile0`, function (sprite, location) {
    info.pauseCountup()
    game.splash("Stats coins top left time", "middle top")
    info.clearCountup()
    info.startCountup()
    sprites.destroy(textSprite)
    game.splash("Use the water its elevator ", " swimm onto the bubbles")
    textsprite2 = textsprite.create("4x10")
    textsprite3 = textsprite.create("2x23")
    tiles.placeOnTile(textsprite2, tiles.getTileLocation(42, 6))
    tiles.placeOnTile(textsprite3, tiles.getTileLocation(51, 7))
    tiles.setCurrentTilemap(tilemap`Mush room ups and downs level 2`)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.QuestionCoin, function (sprite, otherSprite) {
    Coins += 1
    sprites.destroy(otherSprite, effects.halo, 200)
    info.changeScoreBy(1)
})
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile34`, function (sprite, location) {
    for (let value of tiles.getTilesByType(assets.tile`myTile28`)) {
        $Coin$ = sprites.create(assets.image`Coin`, SpriteKind.QuestionCoin)
        tiles.placeOnTile($Coin$, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
        animation.runImageAnimation(
        $Coin$,
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorClosedNorth, function (sprite, location) {
    tiles.setCurrentTilemap(tilemap`Boss one green`)
    Evil_evil_Mush()
    Snake2()
    tiles.placeOnRandomTile(Birdy_1_duck, assets.tile`myTile10`)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Shop, function (sprite, otherSprite) {
    sprites.destroy(Shop)
    tiles.setCurrentTilemap(tilemap`Shop`)
    Boots = sprites.create(assets.image`Jump boots`, SpriteKind.Boot)
    tiles.placeOnTile(Boots, tiles.getTileLocation(10, 5))
    Shield = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Shield)
    tiles.placeOnTile(Birdy_1_duck, tiles.getTileLocation(4, 6))
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Boot, function (sprite, otherSprite) {
    game.splash("Do you want to buy jump boot", "for 5 coins")
...
function bouncebad () {
    for (let value of tiles.getTilesByType(assets.tile`myTile6`)) {
        Eviler_musher1 = sprites.create(assets.image`musher`, SpriteKind.Bat)
...
scene.onOverlapTile(SpriteKind.Player, sprites.builtin.forestTiles22, function (sprite, location) {
    Monkey_2.follow(Birdy_1_duck, 60)
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Shield, function (sprite, otherSprite) {
    game.splash("Do you want to buy shield", "for 10 coins")
    story.showPlayerChoices("yes", "no")
    if (story.checkLastAnswer("yes")) {
        if (Coins > 10) {
            mySprite += -10
            ...
            game.splash("now you can reflect ", "by pressing B")
        }
    } else {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile14`, function (sprite, location) {
    ...
    game.splash("Stats time and coin")
    info.clearCountup()
    textSprite4 = textsprite.create("10x8")
    tiles.placeOnTile(textSprite4, tiles.getTileLocation(20, 6))
    Monkey = sprites.create(img`
        ...
        `, SpriteKind.Enemy)
    tiles.placeOnTile(Monkey, tiles.getTileLocation(31, 8))
    Monkey_2 = sprites.create(img`
        ...
        . . f f f f f f f f f f f f f . 
        `, SpriteKind.Enemy)
    tiles.placeOnTile(Monkey_2, tiles.getTileLocation(32, 4))
    info.startCountup()
    sprites.destroy(Mushroom)
    Birdy_1_duck.ay = 200
    tiles.placeOnRandomTile(Birdy_1_duck, assets.tile`myTile10`)
    tiles.setCurrentTilemap(tilemap`3 pitfalls and monkeys`)
    for (let value of tiles.getTilesByType(assets.tile`myTile6`)) {
        $Coin$ = sprites.create(assets.image`Coin`, SpriteKind.Coin)
        tiles.placeOnTile($Coin$, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile26`, function (sprite, location) {
    ...
    game.splash("Stats time and coin")
    info.clearCountup()
    game.splash("This part is differnt...", "it is a shop level")
    game.splash("go to the shop")
    tiles.setCurrentTilemap(tilemap`grass shop area`)
    tiles.placeOnTile(Birdy_1_duck, tiles.getTileLocation(1, 13))
    Shop = sprites.create(img`
        ...
        `, SpriteKind.Shop)
    tiles.placeOnTile(Shop, tiles.getTileLocation(36, 12))
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    if (sprite.x > 0 && !(otherSprite.isHittingTile(CollisionDirection.Bottom))) {
...
Birdy_1_duck = sprites.create(assets.image`myImage2`, SpriteKind.Player)
game.splash("move with the", "right and left buttons.")
game.splash("Press A to jump")
game.splash("Answer questions to ", "earn coins.")
game.splash("Defeat enemies by ", "jumping on them")
game.splash("HAVE FUN!")
controller.moveSprite(Birdy_1_duck, 100, 0)
info.startCountup()
textSprite = textsprite.create("5x2")
tiles.placeOnTile(textSprite, tiles.getTileLocation(10, 4))
statusbar2 = statusbars.create(20, 4, StatusBarKind.Health)
statusbar2.value = 100
statusbar2.attachToSprite(Birdy_1_duck)
scene.cameraFollowSprite(Birdy_1_duck)
tiles.placeOnRandomTile(Birdy_1_duck, assets.tile`myTile10`)
Birdy_1_duck.ay = 200
